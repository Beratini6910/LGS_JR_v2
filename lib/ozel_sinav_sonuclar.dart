...
import 'package:lgs_jr_v2/sonuc_listesi.dart';
import 'package:page_transition/page_transition.dart';

class Ozel_Sinav_Sonuclar extends StatefulWidget {
  @override
  _Ozel_Sinav_SonuclarState createState() => _Ozel_Sinav_SonuclarState();
}

class _Ozel_Sinav_SonuclarState extends State<Ozel_Sinav_Sonuclar> {
    ...
    await FirebaseFirestore.instance.collection("Sinavlar")
      ...
      if (value.exists) {
        FirebaseFirestore.instance.collection("Sinavlar")
          ...
          sinavSahibi = data["00_Sinavi_Olusturan_Hesap_Maili"];
        });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Özel Sınav Sonuçları",
          style: TextStyle(
              color: Colors.white
          ),),
      ),
                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: const Text("Lütfen Sonuçlarını Görüntülemek İstediğiniz Sınavınızın Adını ve Şifresini Giriniz:",
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                Timer(Duration(milliseconds: 1000), (){
                                  ...
                                  if(sinavSahibi != email){
                                    kontrol=0;
                                    showDialog<String>(
                                      context: context,
                                      builder: (BuildContext context) => AlertDialog(
                                        title: const Text('Sınav Size Ait Değil.'),
                                        content: const Text("Sınav sonuçlarını sadece sınavı oluşturan öğretmen görüntülüyebilir."),
                                        actions: <Widget>[
                                          TextButton(
                                            onPressed: () => Navigator.pop(context, 'OK'),
                                            child: const Text('Tamam'),
